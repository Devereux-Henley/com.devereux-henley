...
VALUES
  ...
  (13,'a1000000-0000-0000-0000-000000000013', 'Monstrous Cavalry', 'Monstrous creatures ridden as cavalry that combine powerful charge with formidable bulk.', 1, 1, 'f0ce7395-a57f-41e9-ade0-fd13bafc058f', STRFTIME('%Y-%m-%dT%H:%M:%fZ','now'), STRFTIME('%Y-%m-%dT%H:%M:%fZ','now'), null);
