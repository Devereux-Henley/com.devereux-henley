...
UPDATE unit
SET lore = CASE eid
  WHEN '0001000b-0000-4000-8000-000000000000' THEN 'wh_dlc03_lore_beasts'
  WHEN '0001000d-0000-4000-8000-000000000000' THEN 'wh_main_lore_fire'
  WHEN '0001000e-0000-4000-8000-000000000000' THEN 'wh_main_lore_heavens'
  WHEN '00010012-0000-4000-8000-000000000000' THEN 'wh_main_lore_metal'
  WHEN '00010014-0000-4000-8000-000000000000' THEN 'wh_dlc05_lore_shadows'
  WHEN '00010016-0000-4000-8000-000000000000' THEN 'wh_dlc05_lore_life'
  WHEN '00010019-0000-4000-8000-000000000000' THEN 'wh_main_lore_light'
...
family_name = CASE eid
  WHEN '0001000b-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '0001000d-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '0001000e-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '00010012-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '00010014-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '00010016-0000-4000-8000-000000000000' THEN 'Wizard'
  WHEN '00010019-0000-4000-8000-000000000000' THEN 'Wizard'
