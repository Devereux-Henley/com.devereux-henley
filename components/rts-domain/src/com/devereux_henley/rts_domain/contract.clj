...
(def resolve-dispute-specification                schema/resolve-dispute-specification)
...
(def tournament-started-response                  schema/tournament-started-response)
(def tournament-completed-response                schema/tournament-completed-response)
(def tournament-cancelled-response                schema/tournament-cancelled-response)
(def tournament-registration-closed-response      schema/tournament-registration-closed-response)
...
(def start-tournament                             handlers.tournament/start-tournament)
...
(def open-check-in                                handlers.tournament/open-check-in)
(def check-in-player                              handlers.tournament/check-in-player)
(def get-check-in-state                           handlers.tournament/get-check-in-state)
(def check-in-state                               handlers.tournament/check-in-state)
...
(def match-win-threshold                          rules.tournament/match-win-threshold)
