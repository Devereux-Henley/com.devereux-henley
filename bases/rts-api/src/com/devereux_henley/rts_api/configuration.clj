...
(def match-record-configuration
  (handlers :com.devereux-henley.rts-web.web.match-record/parse-replays
            :com.devereux-henley.rts-web.web.match-record/record-match
            :com.devereux-henley.rts-web.web.match-record/modal-view))
