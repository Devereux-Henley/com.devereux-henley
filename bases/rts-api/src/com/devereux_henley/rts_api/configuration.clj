...
(def replay-configuration
  (handlers :com.devereux-henley.rts-web.web.replay/get-replay
            :com.devereux-henley.rts-web.web.replay/create-replay
            :com.devereux-henley.rts-web.web.replay/declare-winner
            :com.devereux-henley.rts-web.web.view/upload-replay-view
            :com.devereux-henley.rts-web.web.view/my-replays-view
            :com.devereux-henley.rts-web.web.view/replay-view))
